<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a href="<?= SERVERURL ?>reservation-reservation/"><i class="far fa-calendar-alt"></i> &nbsp; RESERVACIONES</a>
        </li>
        <li>
        ...
        <li>
            <a class="active" href="<?= SERVERURL ?>reservation-search/"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; BUSCAR POR FECHA</a>
        </li>
    </ul>
</div>
        ...
        <table class="table table-dark table-sm">
            ...
            <tbody>
                <tr class="text-center">
                    ...
                    <td>
                        <a href="<?= SERVERURL ?>reservation-update/" class="btn btn-success">
